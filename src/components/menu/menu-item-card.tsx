        ...
        return (
            <>
                <motion.div
                    ...
                    className="relative group overflow-hidden rounded-lg bg-card shadow-lg shadow-purple-500/10 dark:shadow-purple-800/20 cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 hover:-translate-y-1 flex flex-col justify-between p-4 min-h-[160px] user-select-none"
                ...
                >
                    ...
                    <div>
                        <h3 className="font-headline text-xl font-bold leading-tight text-foreground">
